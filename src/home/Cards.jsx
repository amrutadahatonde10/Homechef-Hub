...
const Cards = () => {
  const cardData = [
    ...
    {
      id: 4,
      image: 'https://imgs.search.brave.com/YjzGHVOoIEoSLQIjdZ26WXWncPPLtwG8PMnDfMH52e4/rs:fit:500:0:0:0/g:ce/aHR0cHM6Ly90My5m/dGNkbi5uZXQvanBn/LzA5LzUxLzUxLzEw/LzM2MF9GXzk1MTUx/MTAxOV9NMElwSDNu/NjhwTFpkZGJNNXl0/SXY5SmtMTDdrRkox/dC5qcGc',
      title: 'Veg Thali',
      ingredients: ['Rice', 'Dal', 'Roti', 'Vegetables', 'Pickle', 'Curd', 'Chapati'],
      time: '1 hour'
    },
  ];
